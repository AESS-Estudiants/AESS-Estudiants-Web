...
const AESSBot = () => {
  ...
  const talleres = [
    ...
    { fecha: '4 Mar 2026', hora: '12:00 - 14:00', titulo: 'Sensors', desc: 'Connexió i ús de sensors: pulsadors, ultrasó, sharp i sensors de llum del terra.', icon: 'fas fa-microchip' },
    { fecha: '18 Mar 2026', hora: '12:00 - 14:00', titulo: 'PCB', desc: 'Disseny de plaques i tècniques de soldadura en placa de topos.', icon: 'fas fa-memory' },
    { fecha: '25 Mar 2026', hora: '12:00 - 14:00', titulo: 'Disseny 3D', desc: 'Disseny 3D amb OnShape.', icon: 'fas fa-cube' },
