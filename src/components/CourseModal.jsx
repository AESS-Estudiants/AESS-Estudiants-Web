            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body">
                    ...
                    <section className="modal-section">
                        ...
                        <p>Les inscripcions per a la propera edició s'obriran a <strong>Gener 2026</strong>. Estigues atent a les nostres xarxes socials per no perdre't cap novetat!</p>
                    </section>
                </div>
